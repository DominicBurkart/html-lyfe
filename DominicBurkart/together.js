...
var backgroundImagePath= "assets/together/bg.jpg"; //images and backgrounds
var bg;
var sphereImagePath = "assets/together/spherebg.jpg";
var spherebg;
...
function setup() {
  for (var i = 0; i < bNum; i++){
    aud[i] = loadSound('assets/together/'+i+'.m4a');
  }
